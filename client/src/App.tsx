...
function Router() {
  return <DashboardShell><Switch><Route path="/" component={Overview} /><Route path="/lab" component={LabPage} /><Route path="/problem" component={ProblemStatement} /><Route path="/modules" component={AdvancedModules} /><Route path="/verify" component={LabPage} /><Route path="/settings" component={Settings} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch></DashboardShell>;
}
