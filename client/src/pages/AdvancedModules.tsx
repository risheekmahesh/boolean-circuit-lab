...
function ThreeBitMultiplierCard() {
  ...
  return <article className="module-card multiplier-card" id="multiplier-3bit">
    ...
    <div className="module-content-grid">
      ...
      <CircuitFrame title="DIAGONAL ARRAY + RIPPLE SUMMATION" scale={scale} onScaleChange={setScale} width={1400} height={620}>
        ...
        <Wire value={p00} d="M318 40 H1240" />
        ...
        <Wire source="derived" value={sum5} d="M1278 86 H1360" /><Wire source="derived" value={p5} d="M1278 176 H1360" /><Wire source="derived" value={p6} d="M1278 270 H1360" />
        <Terminal x={1240} y={40} label="P₀" value={p0} kind="output" /><Terminal x={1240} y={86} label="P₁" value={p1} kind="output" /><Terminal x={1240} y={132} label="P₂" value={p2} kind="output" /><Terminal x={1240} y={178} label="P₃" value={p3} kind="output" /><Terminal x={1240} y={224} label="P₄" value={p4} kind="output" /><Terminal x={1240} y={270} label="P₅" value={p5} kind="output" /><Terminal x={1240} y={316} label="P₆" value={p6} kind="output" />
